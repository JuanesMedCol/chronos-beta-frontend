export const StopListService = 
    async (pageIndex) => {
    try {
      const response = await fetch(process.env.REACT_APP_API_URL + `/stops?page=${pageIndex}`);
...
export const StopCreateService = async (prueba) => {
  try {
...
export const StopEditService = async (prueba) => {
  try {
