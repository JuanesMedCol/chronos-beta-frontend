...
<details>
<summary>Guia de GitLab</summary>
...
```
cd existing_repo
git remote add origin http://gitlab.iudigital.edu.co/ds-iudigital/card_system/card_system_frontend.git
git branch -M main
...
- [ ] [Set up project integrations](http://gitlab.iudigital.edu.co/ds-iudigital/card_system/card_system_frontend/-/settings/integrations)
